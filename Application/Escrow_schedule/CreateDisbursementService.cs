    ...
    public class CreateDisbursementService
    {
        ...
        public class Handler : IRequestHandler<Command>
        {
            ...
            public async Task<Unit> Handle(Command request, CancellationToken cancellationToken)
            {
                ...
                {
                    Console.WriteLine(payment_[0].Loan_Id);
                    // var loan_details = this.context.LoanDetails.Find(payment_[0].Loan_Id);
                    // loan_details.monthly_payment_amount = payment_[0].Monthly_Payment_Amount;
                    // this.context.LoanDetails.Update(loan_details);
                    return Unit.Value;
                }
